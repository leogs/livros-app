package com.springboot.livrosapp.controller;
...
import com.springboot.livrosapp.entity.Livro;
import com.springboot.livrosapp.repository.LivroRepository;
...
public class LivroController {
      ...
      public String listaLivros(@PathVariable("autor") String autor, Model model) {
            ...
            /*
             * O return indica qual html de view chamar para responder à requisição
             */
            return "listaLivros";
      }
